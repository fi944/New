...
ownerhson_id = 1401229482
@sedthon.on(events.NewMessage(outgoing=False, pattern='/start'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('اهلا مطوري محمد @Mohammedll ')

ownerhson_id = 1401229482
@sedthon.on(events.NewMessage(outgoing=False, pattern='/b'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
ownerhson_id = 1401229482
@sedthon.on(events.NewMessage(outgoing=False, pattern='/z'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('.تجميع الازرق ')
	
ownerhson_id = 1401229482
@sedthon.on(events.NewMessage(outgoing=False, pattern='/l'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('.تجميع العرب ')
	
ownerhson_id = 1401229482
@sedthon.on(events.NewMessage(outgoing=False, pattern='/m'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('.تجميع المليون ')
...
ownerhson_id = 1401229482
@sedthon.on(events.NewMessage(outgoing=False, pattern='/1'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply(' لزم حدك ')
	
ownerhson_id = 1401229482
@sedthon.on(events.NewMessage(outgoing=False, pattern='/2'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply(' سوف اذبحك  ')

ownerhson_id = 1401229482
@sedthon.on(events.NewMessage(outgoing=False, pattern='/3'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply(' انجب يلا  ')
	
ownerhson_id = 1401229482
@sedthon.on(events.NewMessage(outgoing=False, pattern='/4'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('ادبسززززززززززز   ')
